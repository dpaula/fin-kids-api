...
@Schema(description = "Payload para atualizacao de meta.")
public record UpdateGoalRequest(
        ...
        Long accountId,
        @Schema(description = "Nome atualizado da meta", example = "Notebook")
        @NotBlank(message = "name e obrigatorio.")
        @Size(max = 120, message = "name deve ter no maximo 120 caracteres.")
        String name,
        @Schema(description = "Novo valor alvo da meta", example = "3200.00")
